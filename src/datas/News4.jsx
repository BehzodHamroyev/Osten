const data = {
  ...
  subTitle:'Продукция компании «Стальной Канат» - это современное надёжное оборудование от экспертов. Как производители, мы считаем основной целью внедрения новых технических разработок.',
